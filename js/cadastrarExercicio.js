...
function listarExercicios(){
  ...
  var lista = '<table class="table table-striped">';
      ...
      lista = lista + '<th scope="col">Parte</th>';
      lista = lista + '<th scope="col">Equip.</th>';
  ...
  for(var i=0;i < indiceArray.length; i++){
    ...
    if (chave != null) {
      ...
      lista = lista + '<td>'+exercicioArray.AreaExercicio+'</td>';
      lista = lista + '<td>'+exercicioArray.EquipamentoExercicio+'</td>';
